export default {
  ...
  traffic: {
    ...
    serverUsage: 'Per-user server traffic', serverUserUsage: 'Server user traffic details',
    serverUserUsageTitle: 'User traffic on “{name}”', limitSettings: 'Server traffic limit', period: 'Period',
