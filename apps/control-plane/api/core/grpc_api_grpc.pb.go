...
const (
	ApiNodeService_AddNode_FullMethodName    = "/ApiNodeService/AddNode"
	ApiNodeService_RemoveNode_FullMethodName = "/ApiNodeService/RemoveNode"
)
...
func (c *apiNodeServiceClient) AddNode(ctx context.Context, in *NodeAddDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiNodeService_AddNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiNodeServiceClient) RemoveNode(ctx context.Context, in *NodeRemoveDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiNodeService_RemoveNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ApiNodeService_AddNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiNodeService_AddNode_FullMethodName,
	}
...
func _ApiNodeService_RemoveNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiNodeService_RemoveNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ApiNodeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "core/grpc_api.proto",
}

const (
	ApiNodeServerService_GetNodeServerInfo_FullMethodName = "/ApiNodeServerService/GetNodeServerInfo"
)
...
func (c *apiNodeServerServiceClient) GetNodeServerInfo(ctx context.Context, in *NodeServerInfoDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiNodeServerService_GetNodeServerInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedApiNodeServerServiceServer
// for forward compatibility
type ApiNodeServerServiceServer interface {
	GetNodeServerInfo(context.Context, *NodeServerInfoDto) (*Response, error)
}

// UnimplementedApiNodeServerServiceServer should be embedded to have forward compatible implementations.
...
func _ApiNodeServerService_GetNodeServerInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiNodeServerService_GetNodeServerInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	ApiAccountService_RemoveAccount_FullMethodName = "/ApiAccountService/RemoveAccount"
)
...
func (c *apiAccountServiceClient) RemoveAccount(ctx context.Context, in *AccountRemoveDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiAccountService_RemoveAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedApiAccountServiceServer
// for forward compatibility
type ApiAccountServiceServer interface {
	RemoveAccount(context.Context, *AccountRemoveDto) (*Response, error)
}

// UnimplementedApiAccountServiceServer should be embedded to have forward compatible implementations.
...
func _ApiAccountService_RemoveAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiAccountService_RemoveAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	ApiStateService_GetNodeState_FullMethodName       = "/ApiStateService/GetNodeState"
	ApiStateService_GetNodeServerState_FullMethodName = "/ApiStateService/GetNodeServerState"
)
...
func (c *apiStateServiceClient) GetNodeState(ctx context.Context, in *NodeStateDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiStateService_GetNodeState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiStateServiceClient) GetNodeServerState(ctx context.Context, in *NodeServerStateDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiStateService_GetNodeServerState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedApiStateServiceServer
// for forward compatibility
...
// UnimplementedApiStateServiceServer should be embedded to have forward compatible implementations.
...
func _ApiStateService_GetNodeState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiStateService_GetNodeState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiStateService_GetNodeServerState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiStateService_GetNodeServerState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	ApiKernelService_GetKernelInventory_FullMethodName   = "/ApiKernelService/GetKernelInventory"
	ApiKernelService_StartKernelOperation_FullMethodName = "/ApiKernelService/StartKernelOperation"
	ApiKernelService_GetKernelOperation_FullMethodName   = "/ApiKernelService/GetKernelOperation"
)

// ApiKernelServiceClient is the client API for ApiKernelService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type ApiKernelServiceClient interface {
	GetKernelInventory(ctx context.Context, in *KernelInventoryRequest, opts ...grpc.CallOption) (*Response, error)
	StartKernelOperation(ctx context.Context, in *KernelOperationRequest, opts ...grpc.CallOption) (*Response, error)
	GetKernelOperation(ctx context.Context, in *KernelOperationStateRequest, opts ...grpc.CallOption) (*Response, error)
}

type apiKernelServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewApiKernelServiceClient(cc grpc.ClientConnInterface) ApiKernelServiceClient {
	return &apiKernelServiceClient{cc}
}

func (c *apiKernelServiceClient) GetKernelInventory(ctx context.Context, in *KernelInventoryRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiKernelService_GetKernelInventory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiKernelServiceClient) StartKernelOperation(ctx context.Context, in *KernelOperationRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiKernelService_StartKernelOperation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiKernelServiceClient) GetKernelOperation(ctx context.Context, in *KernelOperationStateRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, ApiKernelService_GetKernelOperation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ApiKernelServiceServer is the server API for ApiKernelService service.
// All implementations should embed UnimplementedApiKernelServiceServer
// for forward compatibility
type ApiKernelServiceServer interface {
	GetKernelInventory(context.Context, *KernelInventoryRequest) (*Response, error)
	StartKernelOperation(context.Context, *KernelOperationRequest) (*Response, error)
	GetKernelOperation(context.Context, *KernelOperationStateRequest) (*Response, error)
}

// UnimplementedApiKernelServiceServer should be embedded to have forward compatible implementations.
type UnimplementedApiKernelServiceServer struct {
}

func (UnimplementedApiKernelServiceServer) GetKernelInventory(context.Context, *KernelInventoryRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetKernelInventory not implemented")
}
func (UnimplementedApiKernelServiceServer) StartKernelOperation(context.Context, *KernelOperationRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartKernelOperation not implemented")
}
func (UnimplementedApiKernelServiceServer) GetKernelOperation(context.Context, *KernelOperationStateRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetKernelOperation not implemented")
}

// UnsafeApiKernelServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ApiKernelServiceServer will
// result in compilation errors.
type UnsafeApiKernelServiceServer interface {
	mustEmbedUnimplementedApiKernelServiceServer()
}

func RegisterApiKernelServiceServer(s grpc.ServiceRegistrar, srv ApiKernelServiceServer) {
	s.RegisterService(&ApiKernelService_ServiceDesc, srv)
}

func _ApiKernelService_GetKernelInventory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KernelInventoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiKernelServiceServer).GetKernelInventory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiKernelService_GetKernelInventory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKernelServiceServer).GetKernelInventory(ctx, req.(*KernelInventoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiKernelService_StartKernelOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KernelOperationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiKernelServiceServer).StartKernelOperation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiKernelService_StartKernelOperation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKernelServiceServer).StartKernelOperation(ctx, req.(*KernelOperationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiKernelService_GetKernelOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KernelOperationStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiKernelServiceServer).GetKernelOperation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiKernelService_GetKernelOperation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKernelServiceServer).GetKernelOperation(ctx, req.(*KernelOperationStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// ApiKernelService_ServiceDesc is the grpc.ServiceDesc for ApiKernelService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ApiKernelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ApiKernelService",
	HandlerType: (*ApiKernelServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetKernelInventory",
			Handler:    _ApiKernelService_GetKernelInventory_Handler,
		},
		{
			MethodName: "StartKernelOperation",
			Handler:    _ApiKernelService_StartKernelOperation_Handler,
		},
		{
			MethodName: "GetKernelOperation",
			Handler:    _ApiKernelService_GetKernelOperation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "core/grpc_api.proto",
